...
class MainActivity : AppCompatActivity() {
    ...
    private val mLocationCallback = object : LocationCallback() {
        override fun onLocationResult(locationResult: LocationResult) {
            ...
            weatherViewModel.setLatitude(mLastLocation.latitude)
            Log.e("Current Latitude", "$mLatitude")
            //val test0 = weatherViewModel.isLoading.value
            //val test1: Double? = weatherViewModel.mLatitude.value
            //Log.e("Current Latitude", "$test1")
            mLongitude = mLastLocation.longitude
            weatherViewModel.setLongitude(mLastLocation.longitude)
            Log.e("Current Longitude", "$mLongitude")
            //val test2: Double? = weatherViewModel.mLongitude.value
            //Log.e("Current Longitude", "$test2")
